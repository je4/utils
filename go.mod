...
require (
	...
	github.com/je4/certloader/v2 v2.0.1
...
require (
	...
	github.com/je4/minivault/v2 v2.0.0-20240802094140-b281a9263048 // indirect
	github.com/je4/trustutil/v2 v2.0.20 // indirect
